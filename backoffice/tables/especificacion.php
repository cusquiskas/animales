<?php
    class articulo {
        ...
        private function insert() {
            $datos = array(
                0=>array("tipo"=>'i', "dato"=>$this->esp_codart),
                1=>array("tipo"=>'d', "dato"=>$this->esp_peso),
                2=>array("tipo"=>'s', "dato"=>$this->esp_color),
                3=>array("tipo"=>'d', "dato"=>$this->esp_importe),
                4=>array("tipo"=>'d', "dato"=>$this->esp_beneficio)
            );
            $query = "INSERT 
                        INTO ESPECIFICACION 
                             (esp_codart,
        ...
        private function update() {
            $datos = array(
                ...
                3=>array("tipo"=>'d', "dato"=>$this->esp_importe),
                4=>array("tipo"=>'d', "dato"=>$this->esp_beneficio),
                5=>array("tipo"=>'i', "dato"=>$this->esp_codesp)
            );
        ...
        private function select() {
            $datos = array(
                0=>array("tipo"=>'i', "dato"=>$this->esp_codart),
                1=>array("tipo"=>'d', "dato"=>$this->esp_peso),
                2=>array("tipo"=>'i', "dato"=>$this->esp_codesp)
            );
            $query = "select *
                        from ARTICULO
