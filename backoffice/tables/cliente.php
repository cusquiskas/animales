<?php
    class cliente {
        ...
        private function setDatos($array) {
            $this->cli_codcli = (int)   $array["cli_codcli"];
            $this->cli_email  = (string)$array["cli_email"];
            $this->cli_nombre = (string)$array["cli_nombre"];
            $this->cli_apell1 = (string)$array["cli_apell1"];
            $this->cli_telefn = (string)$array["cli_telefn"];
            $this->cli_postal = (string)$array["cli_postal"];
            return 0;
        }
        ...
        private function select() {
            ...
            $this->array = $link->consulta($query, $array);
            $link->close();
            $this->error = $link->getListaErrores();
            return (($link->hayError())?1:0);
        }
